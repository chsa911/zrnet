...
# ensure initramfs-tools config exists
...
# NEW: ensure udev.conf exists for the initramfs udev hook
mkdir -p /mnt/etc/udev
cat > /mnt/etc/udev/udev.conf <<'EOL'
# Minimal udev configuration
udev_log="info"
children_max=16
resolve_names=early
EOL
