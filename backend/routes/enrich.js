...
async function metaFromDb(pool, { isbn13, isbn10 }) {
  ...
  return {
    ...
    author_abbr: b.author_abbr || null,
    author_nationality: b.author_nationality || null,
    place_of_birth: b.place_of_birth || null,
    male_female: b.male_female || null,
    published_titles: b.published_titles ?? null,
    number_of_millionsellers: b.number_of_millionsellers ?? null,
...
router.get("/lookup", async (req, res, next) => {
  try {
    ...
    const suggested = {
      ...
      author_abbr: meta?.author_abbr || null,
